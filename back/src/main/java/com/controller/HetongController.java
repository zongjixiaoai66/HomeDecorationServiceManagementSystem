...
//                            hetongEntity.setHetongTypes(Integer.valueOf(data.get(0)));   //合同状态 要改的
//                            hetongEntity.setHetongHuafei(data.get(0));                    //合同金额 要改的
//                            hetongEntity.setHetongWeiyuejin(data.get(0));                    //违约金 要改的
