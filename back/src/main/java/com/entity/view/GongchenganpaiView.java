...
public class GongchenganpaiView extends GongchenganpaiEntity implements Serializable {
	...
	* 工程进度的值
	*/
	@ColumnInfo(comment="工程进度的字典表值",type="varchar(200)")
	private String gongchenganpaiValue;
	...
	public GongchenganpaiView() {

	}

	public GongchenganpaiView(GongchenganpaiEntity gongchenganpaiEntity) {
		try {
			BeanUtils.copyProperties(this, gongchenganpaiEntity);
	...
	* 获取： 工程进度的值
	*/
	public String getGongchenganpaiValue() {
		return gongchenganpaiValue;
	}
	/**
	* 设置： 工程进度的值
	*/
	public void setGongchenganpaiValue(String gongchenganpaiValue) {
		this.gongchenganpaiValue = gongchenganpaiValue;
	}
	...
	public String toString() {
		return "GongchenganpaiView{" +
			", gongchenganpaiValue=" + gongchenganpaiValue +
