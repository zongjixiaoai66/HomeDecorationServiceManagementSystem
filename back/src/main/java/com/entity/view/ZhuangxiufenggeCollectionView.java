...
public class ZhuangxiufenggeCollectionView extends ZhuangxiufenggeCollectionEntity implements Serializable {
	...
	*/
	...
	private String zhuangxiufenggeCollectionValue;
	...
	public ZhuangxiufenggeCollectionView() {

	}

	public ZhuangxiufenggeCollectionView(ZhuangxiufenggeCollectionEntity zhuangxiufenggeCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhuangxiufenggeCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZhuangxiufenggeCollectionValue() {
		return zhuangxiufenggeCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZhuangxiufenggeCollectionValue(String zhuangxiufenggeCollectionValue) {
		this.zhuangxiufenggeCollectionValue = zhuangxiufenggeCollectionValue;
	}
	...
	public String toString() {
		return "ZhuangxiufenggeCollectionView{" +
			", zhuangxiufenggeCollectionValue=" + zhuangxiufenggeCollectionValue +
