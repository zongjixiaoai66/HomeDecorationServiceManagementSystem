...
public class ZhucaiCollectionView extends ZhucaiCollectionEntity implements Serializable {
	...
	*/
	...
	private String zhucaiCollectionValue;
	...
	public ZhucaiCollectionView() {

	}

	public ZhucaiCollectionView(ZhucaiCollectionEntity zhucaiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhucaiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZhucaiCollectionValue() {
		return zhucaiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZhucaiCollectionValue(String zhucaiCollectionValue) {
		this.zhucaiCollectionValue = zhucaiCollectionValue;
	}
	...
	public String toString() {
		return "ZhucaiCollectionView{" +
			", zhucaiCollectionValue=" + zhucaiCollectionValue +
