...
var centerMenu = [
    ...
    ,{
        name: '工程安排',
        url: '../gongchenganpai/list.html'
    }
    ,{
        name: '售后服务',
        url: '../shouhou/list.html'
    }
    ,{
        name: '装修风格收藏',
        url: '../zhuangxiufenggeCollection/list.html'
    }
    ,{
        name: '主材收藏',
        url: '../zhucaiCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '装修风格',
        url: './pages/zhuangxiufengge/list.html'
    },
    {
        name: '主材',
        url: './pages/zhucai/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/yizhanshijiazhuangfuwu/admin/dist/index.html#/login";
