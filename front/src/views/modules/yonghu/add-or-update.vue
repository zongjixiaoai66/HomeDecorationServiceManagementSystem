        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房源" prop="fangyuanTypes">
                        <el-select v-model="ruleForm.fangyuanTypes" :disabled="ro.fangyuanTypes" placeholder="请选择房源">
                            <el-option
