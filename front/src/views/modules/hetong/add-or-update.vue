    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="合同名称" prop="hetongName">
                       <el-input v-model="ruleForm.hetongName"
                                 placeholder="合同名称" clearable  :readonly="ro.hetongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="合同名称" prop="hetongName">
                           <el-input v-model="ruleForm.hetongName"
                ...
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.hetongFile" label="合同文件" prop="hetongFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.hetongFile"  >合同文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div v-if="type=='info'">
                        <el-form-item class="input" label="合同状态" prop="hetongValue">
                        <el-input v-model="ruleForm.hetongValue"
                            placeholder="合同状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="合同金额" prop="hetongHuafei">
                       <el-input v-model="ruleForm.hetongHuafei"
                                 placeholder="合同金额" clearable  :readonly="ro.hetongHuafei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="合同金额" prop="hetongHuafei">
                           <el-input v-model="ruleForm.hetongHuafei"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="违约金" prop="hetongWeiyuejin">
                       <el-input v-model="ruleForm.hetongWeiyuejin"
                                 placeholder="违约金" clearable  :readonly="ro.hetongWeiyuejin"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="违约金" prop="hetongWeiyuejin">
                           <el-input v-model="ruleForm.hetongWeiyuejin"
                                     placeholder="违约金" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="合同内容" prop="hetongContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.hetongContent" label="合同内容" prop="hetongContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   hetongWeiyuejin: [
                              { required: true, message: '违约金不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.hetongContent = _this.ruleForm.hetongContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.hetongContent = this.ruleForm.hetongContent.replaceAll(this.$base.url,"");
                        this.$http({
