    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">一站式家装服务管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="房源" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.fangyuanTypes" autocomplete="off" placeholder="房源"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="户型" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.huxingTypes" autocomplete="off" placeholder="户型"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            // yonghu 中的 房源 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.fangyuanTypes== null ||this.ruleForm.fangyuanTypes== "")){
                            //     this.$message.error("房源不能为空");
                            //     return
                            // }
                            // yonghu 中的 户型 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.huxingTypes== null ||this.ruleForm.huxingTypes== "")){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/yizhanshijiazhuangfuwu/img/back-img-bg.jpg);
